...
@push('customCSS')
<link rel="stylesheet" href="{{ asset('admin/css/mail-box.css') }}">
                    ...
                    <div class="inbox-body">
                        <div class="mail-option">
                            <div class="chk-all">
                                ...
                                <div class="btn-group">
                                    {{-- 
                                        TODO: Custom all button 
                                    --}}
                                    <a class="btn mini all" href="#pablo" id="groupCheckBox" data-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                        All
                                        <i class="fa fa-angle-down "></i>
                                    </a>
                                    
                                    <div class="dropdown-menu" aria-labelledby="groupCheckBox">
                        ...
                        <table class="table table-inbox table-hover">
                            <tbody>
                                ...
                                <tr class="">
                                    ...
                                    <td class="view-message view-message">Forget Google AdWords: Un-Limited Clicks fo
                                    </td>
                                    <td class="view-message inbox-small-cells"><i class="fa fa-paperclip"></i></td>
