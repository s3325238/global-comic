				...
				<table class="email-content" width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td class="email-masthead">
							<a class="email-masthead_name">Global Comics</a>
						</td>
					</tr>
					<!-- Email Body -->
					<tr>
							...
							<table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td class="content-cell">
										...
										<p>Thanks for signing up for Global Comic! We're excited to have you as an early user.
										</p>
										<!-- Action -->
													...
													<div
														...
														<span
															...
															<span style="font-size: 16px; line-height: 32px;">
																<a href="{{route('emailSent',["emai" => $user->email, "verifyToken" => $user->verifyToken])}}"
										...
										<p>Thanks,<br>The Global Comics Team</p>
										<!-- Sub copy -->
										<table class="body-sub">
											<tr>
												<td>
													...
													<p class="sub">
														<a
															href="{{route('emailSent',["emai" => $user->email, "verifyToken" => $user->verifyToken])}}">
															{{ env('APP_URL').'/verify'.'/'.$user->email.'/'.$user->verifyToken }}
														</a>
													</p>
												</td>
											</tr>
